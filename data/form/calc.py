...
in_file = sys.argv[1] #csv file containing results from Point Extraction Tool
# in_file = "/var/www/html/aiddata/DVT3/data/form/Agriculture.csv"

in_type = sys.argv[2] #type of aid the locations in "in_file" represent
# in_type = "Agriculture"

in_country = sys.argv[3] #country the aid in "in_file" is associated with
#in_country = "Nepal"
...
# in_out = sys.argv[6] #output file
in_out = "/var/www/html/aiddata/home/data/form/form_data.json"
# in_outPath = "/home/detuser/Desktop/form point extracts"
# in_outFile = "json_output.json"
...
with open (in_file, 'rb') as csv_handle:	
	...
	for row in csv_data:
		...
		try:
			aid = float(row[in_field]) / int(row["count"])
		except:
			aid = 0
